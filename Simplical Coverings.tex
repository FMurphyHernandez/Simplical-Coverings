...
\begin{proposition}
Let $(S,\mathcal{K})$ be a complex, and $((T,\mathcal{L}),p)$ a covering complex of $(S,\mathcal{K})$. Then $((T,\mathcal{L}),p)$ is a geometric covering complex of $(S,\mathcal{K})$ if and only if $p$ reflects maximal simplices.
\end{proposition}
...
\]
for $\phi,\psi\in \vert (S,\mathcal{K})\vert$. When we endowed $\vert (S,\mathcal{K})\vert$ with the metric topology we denote it by $\vert (S,\mathcal{K})\vert_d$. There is a second topology for $\vert (S,\mathcal{K})\vert$ called the coherent topology. We may think each simplex $\sigma\in\mathcal{K}$ as a complex, so for each simplex we have a geometric ralization $\vert\sigma\vert$. Then we have an inclusion $i_\sigma\colon\vert\sigma\vert\longrightarrow \vert (S,\mathcal{K})\vert_d$. The coherent topology on $\vert (S,\mathcal{K})\vert$ is the one which makes all the inclusions $i_\sigma$ continuous. Usually, $\vert (S,\mathcal{K})\vert$ is considered with the coherent topology.................
\end{definition}
